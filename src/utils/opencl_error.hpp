...
namespace utils{
    ...
    //Return corresponding OpenCL error based on error code
    ...
    inline void checkCLError(cl_int err, std::string msg, std::string fncName, cl_program program, cl_device_id clDevice){
